...
public abstract class Shape {
    protected int rb;                // row position of base point
    protected int cb;                // col position of base point
    protected char character;        // drawing character
    ...
    public abstract void draws(Window windowShape) throws Exception;
    ...
    public String getSpecs() {
        StringBuilder specs = buildSpecsInFormat();
